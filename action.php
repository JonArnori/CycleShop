				...
				echo '
                    ...
                    <div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price"><span class="qty">'.$n.'</span>&euro;'.$product_price.'</h4>
												</div>
			...
			<form method="post" action="login_form.php">
				...
				<tfoot>
					...
					<tr>
						...
						<td class="hidden-xs text-center"><b class="net_total" ></b>&euro;</td>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/mobigo/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/mobigo/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/mobigo/cancel.php"/>
